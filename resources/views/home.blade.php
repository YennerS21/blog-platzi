@extends('template')
@section('content')
  <div class="bg-gray-900 px-20 py-16 rounded-lg mb-8">
      ...
      <p class="text-sm text-gray-400 mt-2">Proyecto de desarrollo web con LARAVEL</p>
      {{-- <img src="{{ asset('img/dev.png') }}" class="absolute h-12"/> --}}
  </div>
  <div class="px-4">
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
      @foreach ($posts as $post)
        <a href="{{ route('post', $post->slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
          ...
          <div class="text-xs text-gray-900 opacity-75 flex items-center gap-2">
